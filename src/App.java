            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    while (true) {
                        ...
                        int orden;
                        do {
                            orden = leerEnteroValido(scanner, "Escoja de que manera desea ordenar: 1 = ascendente o 2 = descendente : ", false);
                            if (orden != 1 && orden != 2) {
                        ...
                        boolean logs = (mostrar == 1);
                        

                        switch (metodo) {
                            case 1:
                                metodos.burbuja(copiaArreglo, ascendente, logs);
                                break;
                            case 2:
                                metodos.seleccion(copiaArreglo, ascendente, logs);
                                break;
                            case 3:
                                metodos.insercion(copiaArreglo, ascendente, logs);
                                break;
                            case 4:
                                metodos.sortBubbleAva(copiaArreglo, ascendente, logs);
                                break;
                        }
