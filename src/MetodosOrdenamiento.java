...
public class MetodosOrdenamiento {
    ...
    // Burbuja normal
    public void burbuja(int[] arreglo, boolean ascendente, boolean logs) {
    ...
    // Selección
    public void seleccion(int[] arreglo, boolean ascendente, boolean logs) {
        int n = arreglo.length;
        for (int i = 0; i < n - 1; i++) {
            int indiceMinOmax = i;
            for (int j = i + 1; j < n; j++) {
    ...
    // Inserción
    public void insercion(int[] arreglo, boolean ascendente, boolean logs) {
        int n = arreglo.length;
        for (int i = 1; i < n; i++) {
            if (logs) {
    ...
    // Burbuja avanzada
    public int[] sortBubbleAva(int[] arreglo, boolean ascendente, boolean logs) {
        int n = arreglo.length;
